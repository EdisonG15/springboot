            ...
            <fo:table-body>
              <xsl:for-each select="/factura/detalles/detalle">
                <fo:table-row>
                  ...
                  <fo:table-cell border="0.5pt solid black"><fo:block><xsl:value-of select="codigoAuxiliar"/></fo:block></fo:table-cell>
            ...
            <fo:table-body>
              <fo:table-row>
                ...
                <fo:table-cell border="0.5pt solid black" padding="4pt">
                  ...
                  <fo:block>IVA 15%: <xsl:value-of select="/factura/infoFactura/totalIva"/></fo:block>
