    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      ...
      <fo:page-sequence master-reference="factura">
        <fo:flow flow-name="xsl-region-body">
          ...
          <!-- Tabla superior -->
          <fo:table width="100%" table-layout="fixed" margin-bottom="10pt">
...
-->
          <!-- Datos del cliente -->
          <fo:table width="100%" table-layout="fixed" font-size="9pt" border="0.5pt solid black" margin-top="5pt" padding="3pt">
            <fo:table-column column-width="100%"/>
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell padding="4pt">
                  <fo:block font-weight="bold">Razón Social / Nombres y Apellidos: <xsl:value-of select="/factura/infoFactura/razonSocialComprador"/></fo:block>
          ...
          <fo:table table-layout="fixed" width="100%" border="0.5pt solid black" font-size="9pt" margin-top="5pt">
            ...
            <fo:table-header>
              <fo:table-row font-weight="bold" background-color="#e0e0e0">
                <fo:table-cell border="0.5pt solid black" display-align="center"><fo:block>Cod. Principal</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid black" display-align="center"><fo:block>Cod. Auxiliar</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid black" display-align="center"><fo:block>Cant.</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid black" display-align="center"><fo:block>Descripción</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid black" display-align="center"><fo:block>Precio Unitario</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid black" display-align="center"><fo:block>Total</fo:block></fo:table-cell>
              </fo:table-row>
            </fo:table-header>
            <fo:table-body>
