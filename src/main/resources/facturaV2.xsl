    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      ...
      <fo:page-sequence master-reference="factura">
        <fo:flow flow-name="xsl-region-body">
          ...
          <fo:table width="100%" table-layout="fixed" margin-bottom="20pt" space-after="20pt">
            ...
            <fo:table-body>
              <fo:table-row>
                ...
                <fo:table-cell border-right="0.5pt solid #BBBBBB" padding="15pt" display-align="before">
                  <fo:block text-align="center" padding-bottom="10pt">
                    <!-- Logo - Asegúrate de que esta ruta sea correcta y la imagen sea accesible -->
                    <fo:external-graphic src="url('file:///C:\Users\Maria Jose\Desktop\Pos\logo.jpg')" content-width="120px"/> <!-- Tamaño del logo ligeramente ajustado -->
                  </fo:block>
          ...
          <!-- Aumentado padding de la tabla y cambiado color del borde para mayor visibilidad sutil -->
          <fo:table width="100%" table-layout="fixed" font-size="9pt" border="0.5pt solid #BBBBBB" padding="15pt" margin-top="20pt" space-after="20pt">
            <fo:table-column column-width="70%"/>
            <fo:table-column column-width="30%"/>
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell padding-right="20pt"> <!-- Aumentado padding-right para más separación -->
                  <fo:block font-weight="bold" line-height="1.5" color="#333333">Razón Social / Nombres y Apellidos: <fo:inline font-weight="normal" color="#555555"><xsl:value-of select="/factura/infoFactura/razonSocialComprador"/></fo:inline></fo:block>
                  <!-- Identificación: etiqueta en negrita, valor normal -->
                  <fo:block line-height="1.5" color="#555555"><fo:inline font-weight="bold" color="#333333">Identificación:</fo:inline> <xsl:value-of select="/factura/infoFactura/identificacionComprador"/></fo:block>
                  <!-- Fecha de Emisión: color para que no sea negro -->
                  <fo:block line-height="1.5" color="#555555"><fo:inline font-weight="bold" color="#333333">Fecha de Emisión:</fo:inline> <xsl:value-of select="/factura/infoFactura/fechaEmision"/></fo:block>
                </fo:table-cell>
                <fo:table-cell>
          ...
          <fo:table table-layout="fixed" width="100%" border="0.5pt solid #BBBBBB" font-size="9pt" margin-top="20pt" space-after="20pt">
            ...
            <fo:table-header>
              <fo:table-row font-weight="bold" background-color="#F8F8F8"> <!-- Fondo de encabezado muy claro -->
                <fo:table-cell border="0.5pt solid #BBBBBB" display-align="center" number-columns-spanned="4" padding="8pt"><fo:block/></fo:table-cell>
                <fo:table-cell border="0.5pt solid #BBBBBB" display-align="center" number-columns-spanned="3" padding="8pt"><fo:block color="#333333">Detalle</fo:block></fo:table-cell>
              </fo:table-row>
              <fo:table-row font-weight="bold" background-color="#F8F8F8">
                <fo:table-cell border="0.5pt solid #BBBBBB" display-align="center" padding="8pt"><fo:block color="#333333">Cod. Principal</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid #BBBBBB" display-align="center" padding="8pt"><fo:block color="#333333">Cod. Auxiliar</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid #BBBBBB" display-align="center" padding="8pt"><fo:block color="#333333">Cant.</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid #BBBBBB" display-align="center" padding="8pt"><fo:block color="#333333">Descripción</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid #BBBBBB" display-align="center" padding="8pt"><fo:block color="#333333">Precio Unitario</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid #BBBBBB" display-align="center" padding="8pt"><fo:block color="#333333">Descuento</fo:block></fo:table-cell>
                <fo:table-cell border="0.5pt solid #BBBBBB" display-align="center" padding="8pt"><fo:block color="#333333">Total</fo:block></fo:table-cell>
              </fo:table-row>
            </fo:table-header>
            <fo:table-body>
            ...
            <fo:table-body>
              <fo:table-row>
                ...
                <fo:table-cell padding-right="20pt" display-align="before">
                  ...
                  <fo:table width="100%" border="0.5pt solid #BBBBBB" padding="10pt" space-after="15pt">
                  ...
                  <fo:table width="100%" border="0.5pt solid #BBBBBB" padding="10pt">
                    <fo:table-column column-width="100%"/>
                    <fo:table-body>
